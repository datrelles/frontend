...
export const TransEcommerce = () => {
  ...
  useEffect(() => {
    const fetchTransportistas = async () => {
      try {
        setLoading(true);
        const data = await getTransportistasEcommerce(jwt, enterpriseShineray);
  ...
  const handleSave = async () => {
    try {
      ...
      handleCloseDialog();
      setTransportistas(await getTransportistasEcommerce(jwt, enterpriseShineray));
    } catch (error) {
      ...
      <Dialog open={open} onClose={handleCloseDialog}>
        ...
        <DialogContent>
          ...
          <TextField
            ...
            fullWidth
            value={formData.cod_tipo_identificacion}
            onChange={handleChange}
          />
        </DialogContent>
        <DialogActions>
