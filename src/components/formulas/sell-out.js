...
export default function SellOut({}) {
  ...
  const createContentItems = [
    createTextFieldItem({
      ...
      label: "Cliente",
      value: codCliente,
      setValue: createDefaultSetter({ setter: setCodCliente }),
    }),
    createTextFieldItem({
      xs: 6,
      id: "cod_modelo",
      label: "Modelo",
      value: codModelo,
      setValue: createDefaultSetter({ setter: setCodModelo }),
    }),
    createTextFieldItem({
      xs: 3,
      id: "anio",
      label: "Año",
      value: anio,
      setValue: createDefaultSetter({ setter: setAnio }),
      type: "number",
    }),
    createTextFieldItem({
      xs: 3,
      ...
      label: "Mes",
      value: mes,
      setValue: createDefaultSetter({ setter: setMes }),
      type: "number",
    }),
    createTextFieldItem({
      xs: 3,
      ...
      label: "Unidades",
      value: unidades,
      setValue: createDefaultSetter({ setter: setUnidades }),
      type: "number",
    }),
    createTextFieldItem({
      xs: 3,
      ...
      label: "Sell out",
      value: sellOut,
      setValue: createDefaultSetter({ setter: setSellOut }),
      required: false,
      type: "number",
    }),
    createTextFieldItem({
      ...
      label: "Código línea",
      value: codLinea,
      setValue: createDefaultSetter({ setter: setCodLinea }),
      required: false,
    }),
    createTextFieldItem({
      xs: 6,
      ...
      value: codTipoLinea,
      setValue: createDefaultSetter({ setter: setCodTipoLinea }),
      required: false,
    }),
  ];
  ...
  const createContentItemsTipoCli = [
    createTextFieldItem({
      ...
      setValue: createDefaultSetter({ setter: setCodTipoCliente }),
    }),
    createTextFieldItem({
      xs: 6,
      id: "cod_modelo",
