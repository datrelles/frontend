  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.auth2) {
        ...
        const maskedChars = "*".repeat(
          data.email.length - (domainSuffix.length + 1)
        );
    ...
    if (/^\d{6}[a-zA-Z]$/.test(pin)) {
      try {
        const res = await fetch(
          `${API}/auth/verify_authorization/${secondAuth}`,
          {
            method: "PUT",
            headers: {
              "Content-Type": "application/json",
        ...
        if (data.access_token) {
          ...
          if ((data.error = "Token expirado")) setAlert("Token expirado");
          else setAlert("Pin Incorrecto");
          setPin("");
        }
      } catch (error) {
        setAlert(error);
                            ...
                            <div className="card-body p-md-5 mx-md-4">
                              ...
                              <form>
                                <p style={{ textAlign: "justify" }}>
                                  Se requiere autenticación de dos factores. Se
                                  ha enviado un código al correo electrónico
                                  correspondiente.
                                </p>
                                <p
                          ...
                          <div className="col-lg-6 d-flex align-items-center gradient-custom-2">
                            <div className="text-white px-3 py-4 p-md-5 mx-md-4">
                              ...
                              <h4
                                ...
                                style={{ color: "black" }}
                              >
                                Bienvenido al Sistema Empresarial Massline
                              </h4>
